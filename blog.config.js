...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，欢迎来到咖米的画廊，这里有我的画和一些记录',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'kaimi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我是一个4岁的幼儿园学生', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://xiaoxinhao.TOP', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客，画廊', // 网站关键词 英文逗号隔开
